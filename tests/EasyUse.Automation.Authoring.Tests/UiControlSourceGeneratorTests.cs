...
namespace EasyUse.Automation.Authoring.Tests;
...
""";
        ...
        using (Assert.Multiple())
        {
            ...
            await Assert.That(generatedSources).Contains("public global::EasyUse.Automation.Abstractions.ITextBoxControl NumbersInput => Resolve<global::EasyUse.Automation.Abstractions.ITextBoxControl>(MainWindowPageDefinitions.NumbersInput);");
            await Assert.That(generatedSources).Contains("public global::EasyUse.Automation.Abstractions.ILabelControl ResultText => Resolve<global::EasyUse.Automation.Abstractions.ILabelControl>(MainWindowPageDefinitions.ResultText);");
